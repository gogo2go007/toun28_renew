...
$(document).ready(function(){
    ...
    // 슬라이드 영역
    var len = $(".visual_pager li").length;
    ...
    $(window).scroll(function(){
        var mTop = $(".mission").offset().top-window.innerHeight;
    ...
    // 제품소개 이미지 슬라이드
    var item = 0;
    var item_wid = $(".pro_list li").width();
    var itme_len = $(".pro_list li").length;
...
// 서브페이지 4_ 쇼핑 리스트 영역
    ...
    // document.querySelector(".sub4_shop_list").innerHTML = createTag;
